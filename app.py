...
def admin_copy_script(uid):
    ...
    lines.append('}')
    lines.append('')
    lines.append('Write-Host "Enviando $($validos.Count) juegos a DBI..." -ForegroundColor Yellow')
    lines.append('Write-Host ""')
    ...
    lines.append('    $sdFolder.CopyHere($shell.Namespace($src).Self)')
    lines.append('}')
    lines.append('')
    lines.append('Write-Host ""')
    lines.append('Write-Host "Todos los juegos enviados. Supervisa el progreso en la Switch." -ForegroundColor Green')
