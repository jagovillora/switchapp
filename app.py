...
def admin_copy_script(uid):
    ...
    lines.append('}')
    lines.append('')
    lines.append('Write-Host "Enviando $($validos.Count) carpetas a DBI..." -ForegroundColor Yellow')
    lines.append('Write-Host ""')
    lines.append('')
    lines.append('# ── Enviar carpetas a DBI una a una sin esperar (DBI las cola) ──')
    ...
    lines.append('Write-Host ""')
    lines.append('Write-Host ""')
    lines.append('Write-Host "Todas las carpetas enviadas. DBI gestiona la cola en la consola." -ForegroundColor Green')
