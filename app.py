...
def admin_copy_script(uid):
    ...
    lines.append('}')
    lines.append('')
    lines.append('# ── Hard links por juego (Win32 API, evita wildcard en corchetes) ──────')
    ...
    lines.append('\'@')
    lines.append('')
    lines.append('$tempDir = Join-Path (Split-Path $origenBase -Parent) ("_switch_install_" + (Get-Random))')
    ...
    lines.append('Write-Host " Carpeta lista: $tempDir" -ForegroundColor Green')
    lines.append('Write-Host " Arrastra ESA CARPETA a la ventana DBI de la Switch." -ForegroundColor Yellow')
    lines.append('Write-Host "================================================================" -ForegroundColor Green')
    lines.append('Write-Host ""')
    lines.append('')
    ...
    lines.append('Write-Host "Listo. Carpeta temporal eliminada." -ForegroundColor Green')
    lines.append('Remove-Item -LiteralPath $tempDir -Recurse -Force -ErrorAction SilentlyContinue')
