...
def admin_copy_script(uid):
    ...
    lines.append('}')
    lines.append('')
    lines.append('Write-Host "Enviando $($validos.Count) carpetas a DBI de golpe..." -ForegroundColor Yellow')
    lines.append('Write-Host ""')
    lines.append('')
    lines.append('# ── Enviar todas las carpetas a DBI de una vez ───────────────')
    ...
    lines.append('    $sdFolder.CopyHere($srcFolder)')
    lines.append('}')
    lines.append('')
    lines.append('Write-Host ""')
    lines.append('Write-Host "$($validos.Count) carpetas enviadas. DBI gestiona la cola en la consola." -ForegroundColor Green')
    lines.append('Write-Host "Puedes cerrar esta ventana y supervisar el progreso en la pantalla de la Switch." -ForegroundColor Gray')
    lines.append('Write-Host ""')
    lines.append('pause')
